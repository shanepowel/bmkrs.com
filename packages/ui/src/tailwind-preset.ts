  ...
  theme: {
    extend: {
      colors: {
        ...
        "bmkrs-orange-dim": tokens.color.orangeDim,
        "bmkrs-orange-soft": tokens.color.orangeSoft,
        "ink-raised": tokens.color.inkRaised,
        ink: { DEFAULT: tokens.color.ink, 2: tokens.color.inkRaised },
        paper: { DEFAULT: tokens.color.paper, 2: tokens.color.paper },
        accent: tokens.color.orange,
        muted: tokens.color.meta,
        line: {
          DEFAULT: tokens.color.rule,
          strong: tokens.color.ruleStrong,
        },
      ...
      fontSize: {
        ...
        lead: [tokens.type.bodyLg, { lineHeight: String(tokens.leading.body) }],
        body: [tokens.type.body, { lineHeight: String(tokens.leading.body) }],
        "body-sm": [tokens.type.bodySm, { lineHeight: String(tokens.leading.body) }],
        "body-lg": [tokens.type.bodyLg, { lineHeight: String(tokens.leading.body) }],
      ...
      spacing: {
        ...
        "bmkrs-section-sm": tokens.space.sectionSm,
