...
export const siteSettings = defineType({
  ...
  fields: [
    ...
    defineField({
      name: "networkPortalUrl",
      title: "Network portal URL",
      type: "url",
      description: "Collaborator and freelancer portal (default https://app.bmkrs.com).",
      initialValue: "https://app.bmkrs.com",
    }),
    defineField({
      name: "networkHireUrl",
      title: "Network: find talent (companies)",
      type: "url",
      initialValue: "https://app.bmkrs.com/hire",
    }),
    defineField({
      name: "networkJoinUrl",
      title: "Network: join (specialists)",
      type: "url",
      initialValue: "https://app.bmkrs.com/join",
    }),
    defineField({
      name: "memberLoginUrl",
      title: "Member login",
      type: "url",
      initialValue: "https://app.bmkrs.com/login",
    }),
