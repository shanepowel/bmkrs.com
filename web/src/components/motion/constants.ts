...
export const painPoints = [
  {
    ...
    body: "everything waits for your input.",
  },
  {
    title: "disconnected suppliers",
    body: "creative, content and delivery all pulling in different directions.",
  },
  {
    title: "lost momentum",
    body: "projects launch strongly then stall.",
  },
];
